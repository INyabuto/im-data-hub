...
You can refer to [dataElement schema](http://im-dev.psi-mis.org/api/schemas/dataElement.json) for more detailed specs.

For now please note the `uid,name,shortName and formName` we discuss these in section \@ref(global-ind) and section \@ref(country-ind) below.
