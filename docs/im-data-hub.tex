...
You can refer to \href{http://im-dev.psi-mis.org/api/schemas/dataElement.json}{dataElement schema} for more detailed specs.

For now please note the \texttt{uid,name,shortName\ and\ formName} we discuss these in section \ref{global-ind} and section \ref{country-ind} below.
...
IM Data Hub indicators are grouped into two;
...
\hypertarget{custom}{%
\chapter{Customization in the IM Datahub}\label{custom}}
...
\hypertarget{trouble}{%
\chapter{Troubleshooting and Getting Help on IM Datahub}\label{trouble}}
