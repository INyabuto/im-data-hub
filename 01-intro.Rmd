...
- A __development instance__ at [dev.imdatahub.org](https://dev.imdatahub.orgg) hosted on a ST-3 plan from BAO Systems since Nov 22nd, 2018 for prototyping, testing and piloting. Analytics run daily at 00:00 and 12:00 UTC (EAT -3h)
...
The easiest way to get started on the IM Data Hub is to log in at the dev server at https://dev.imdatahub.org/ with the IM demo credentials `demoUser` - the pw is provided by your System Admin. 
