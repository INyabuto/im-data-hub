...
\begin{FOO}
\url{https://im-dev.psi-mis.org/api/29/dataElements/eHWYhy8vO8q.json}
\end{FOO}
...
Metadata have \texttt{name}, \texttt{uid}, \texttt{code} at the minimum for uniquely identifying them in the hub. Others also contain \texttt{short\ names} for unique identification.

In the following sections, we discuss the \texttt{names}, \texttt{uid}, \texttt{code}, \texttt{short\ name} and \texttt{sharing\ setting} for different kinds of metadata in the data hub.
